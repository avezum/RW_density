...
date: 
header-includes:
   - \usepackage{rotating, graphicx, dcolumn, longtable, float}
output:
  pdf_document:
...
Lastly, the method that I proposed to measure the shape component of the PD distribution could be flawed. In Table \ref{tab3} I use the well-known Gini coefficient to measure the shape component of the PD distribution. Again, the results shown in Table \ref{tab3} suppport the evidence from the last three tables: *Capital savings* are countercyclical and mostly driven by the effect of GDP growth rate on *Capital savings* from corporate portfolios.   
...
# Policy Discussion: Using Capital Savings to Reduce Capital Ratio Procyclicality
